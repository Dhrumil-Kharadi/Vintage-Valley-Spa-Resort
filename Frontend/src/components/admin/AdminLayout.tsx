...
import { LayoutDashboard, BedDouble, Users, CalendarDays, CreditCard, LogOut, Mail, TicketPercent, FileText } from "lucide-react";
...
const navItems = [
  ...
  { label: "Tariff", to: "/admin/tariff", icon: FileText },
